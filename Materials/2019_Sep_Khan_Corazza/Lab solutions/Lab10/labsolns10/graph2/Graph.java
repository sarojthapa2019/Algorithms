...
public class Graph {
	...
	public int shortestPathLength(Vertex u, Vertex v) {
		ShortestPathLength spl = new ShortestPathLength(this);
		return spl.getShortestPathLength(u,v);
	}
	
	@SuppressWarnings("unchecked")
	public List<Graph> connectedComponents() {
		ConnectedComponentSearch ccs = new ConnectedComponentSearch(this);
		return (List<Graph>)ccs.getComponents()[0];
...
//        System.out.println(g.shortestPathLength(new Vertex("A"), new Vertex("G")));
